...
describe("YouTubePlaylistSpecifierValidator", () => {
  describe("isValid", () => {
    it("should return true for valid YouTube specifiers", () => {
      ...
      for (const id of validIds) {
        expect(YouTubePlaylistSpecifierValidator.isValid(id)).toBe(true);
      }
    });
    ...
    it("should return false for invalid YouTube specifiers", () => {
      ...
      for (const id of invalidIds) {
        expect(YouTubePlaylistSpecifierValidator.isValid(id)).toBe(false);
      }
    });
  });
  ...
  describe("unique", () => {
    ...
    it("should throw an error for invalid YouTube specifiers", () => {
      ...
      for (const id of invalidIds) {
        expect(() => YouTubePlaylistSpecifierValidator.unique(id)).toThrow(
          /Invalid YouTube specifier/,
        );
      }
    });
  });
