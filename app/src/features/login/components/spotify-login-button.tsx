...
export function SpotifyLoginButton({ lang }: SpotifyLoginButtonProps) {
  ...
  return (
    <Button
      className="h-12 w-full bg-[#1DB954] text-white transition-all duration-200 hover:scale-[1.02] hover:bg-[#1ed760] active:scale-[0.98]"
      onClick={handleClick}
    >
