...
export const PlaylistWizardLayout: Story = {
  render: () => (
    <div className="dark bg-background text-foreground min-h-[640px]">
      <SidebarProvider
        defaultOpen
      ...
      <header className="flex h-16 items-center gap-4 px-4 md:px-6">
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-2 text-xl font-bold text-white">
            <div className="flex size-8 items-center justify-center rounded-md bg-pink-600 text-sm font-bold">
              PW
            </div>
