...
>(
  (
    ...
    // TODO: Review the intentionally limited dependency list.
    useEffect(() => {
      if (open) {
      ...
      >
        ...
        <div className="relative">
          {open && (
            <CommandList
              className={cn(
                "animate-in bg-popover text-popover-foreground absolute top-1 z-10 w-full rounded-md border shadow-md outline-none",
                optionsClassName,
              )}
              onMouseLeave={() => {
            ...
            >
              {isLoading ? (
                // TODO: Review whether this fragment is still needed.
                <>{loadingIndicator}</>
              ) : (
                <>
                  {EmptyItem()}
